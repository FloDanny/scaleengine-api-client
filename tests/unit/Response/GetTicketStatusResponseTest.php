...
/**
 * @coversDefaultClass \FloSports\ScaleEngine\Response\GetTicketStatusResponse
 */
class GetTicketStatusResponseTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function successfulReply()
    {
        ...
        $result = GetTicketStatusResponse::fromCommand($mockCommand, $mockFactory);
